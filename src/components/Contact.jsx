          ...
          <div className="contact__success">
            <div className="contact__success-icon" aria-hidden="true">
              <svg viewBox="0 0 48 48" fill="none" width="48" height="48">
                <circle cx="24" cy="24" r="24" fill="#d8f3dc" />
                <path d="M14 24l7 7 13-13" stroke="#2d6a4f" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
