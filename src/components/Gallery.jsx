...
const PROJECTS = [
  {
    ...
    category: 'Création',
    before: { bg: '#4a7c59', label: 'Terrain en friche — herbes hautes, sol nu' },
    after: { bg: '#2d6a4f', label: 'Jardin contemporain avec terrasse et bassin' },
  },
  {
    id: 2,
    title: 'Terrasse bois & gazon à Saint-Germain',
    category: 'Aménagement',
    before: { bg: '#6b705c', label: 'Dalle béton vieillissante, espace non valorisé' },
    after: { bg: '#40916c', label: 'Terrasse en bois composite et gazon synthétique' },
  },
  {
    id: 3,
    title: 'Haie bocagère à Fontainebleau',
    category: 'Plantation',
    before: { bg: '#7f8c6e', label: 'Clôture en parpaing grise et végétation basse' },
    after: { bg: '#52b788', label: 'Haie mixte persistante de 2m avec massifs fleuris' },
  },
  {
    id: 4,
    title: 'Potager surélevé à Vincennes',
    category: 'Création',
    before: { bg: '#5c6b4a', label: 'Pelouse abîmée, sol compacté' },
    after: { bg: '#1b4332', label: 'Carrés potagers en bois, allées gravillonnées' },
  },
]
